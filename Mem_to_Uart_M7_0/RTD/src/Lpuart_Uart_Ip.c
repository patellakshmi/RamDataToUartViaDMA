...
const Lpuart_Uart_Ip_UserConfigType * Lpuart_Uart_Ip_apUserConfig[LPUART_INSTANCE_COUNT];
...
static LPUART_Type * const Lpuart_Uart_Ip_apBases[LPUART_INSTANCE_COUNT] = IP_LPUART_BASE_PTRS;

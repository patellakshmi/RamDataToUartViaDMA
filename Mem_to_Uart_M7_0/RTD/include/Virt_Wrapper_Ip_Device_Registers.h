...
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION       7
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION    0
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_MAJOR_VERSION               3
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_MINOR_VERSION               0
#define RM_VIRT_WRAPPER_IP_DEVICE_REGISTERS_SW_PATCH_VERSION               0
